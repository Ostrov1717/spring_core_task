...
//        userservice.changePassword("Olga.Kurilenko", "WRqqRQMsoy", "1");
//        userservice.authenticate("Olga.Kurilenko", "1");
//        log.info("___________________________________________________________________________________" + "\n");
////
//////        8. Trainer password change.
//        userservice.changePassword("Monica.Dobs", "55555", "2");
...
////        userservice.deactivate("Olga.Kurilenko", "WRqqRQMsoy");
////        traineeService.findByUsername("Olga.Kurilenko", "WRqqRQMsoy");
////        log.info("___________________________________________________________________________________" + "\n");
//
////        12. Activate/De-activate trainer.
////        userservice.deactivate("Monica.Dobs", "55555");
////        trainerService.findByUsername("Monica.Dobs", "55555");
////        log.info("___________________________________________________________________________________" + "\n");
//
